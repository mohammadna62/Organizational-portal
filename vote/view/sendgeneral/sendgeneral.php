...
$sendgeneral_obj= new vote();
$codemeli=$_COOKIE['username'];
$generalpermission= $sendgeneral_obj->sendgeneralStatus($codemeli);
//var_dump($generalpermission[0]);die();
if($generalpermission[0] == 0){
     die('شمار اجازه ارسال پیام به مدیرکل محترم بنیاد شهید و امور ایثارگران تهران بزرگ را  ندارید');

}
?>

<meta http-equiv="refresh" content="300">
<h2 style="color: #ff981a;background-color: #eaeae8;">صفحه ارتباط با مدیرکل بنیاد شهید و امور ایثارگران  تهران بزرگ</h2>
    ...
    <div class="div_1_2_last" style="height:fit-content">
        <div class="div_client_padding">
            <fieldset
                ...
                <form  method="post" name="sendgeneral" onsubmit="return checkFormValidation('sendgeneral','title', 'text');"
                      enctype="multipart/form-data" action="?c=sendgeneral&a=send">
                    <div class="div_240">
