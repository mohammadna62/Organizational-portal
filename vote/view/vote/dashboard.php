...
<div style="background-color: #eaeae8;">
            <fieldset
                ...
                <?php if($voteStatus['voteStatus']==1){echo '<span style="color: red">رای مجمع عمومی صندوق ، شما  ثبت  گردیده است</span>';   } ?>
            </fieldset><br>
    <fieldset
            style="border: solid;border-color:#39ACF7;border-radius: 5px;height:80%;padding: 2px">
        <?php if($inspectvoteStatus['inspectionvotestatus']==1){echo '<span style="color: red">رای انتخابات بازرسی ، شما ثبت  گردیده است</span>';   } ?>
    </fieldset>
</div>
