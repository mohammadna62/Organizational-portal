...
$columnHeader ='';
$columnHeader = "ID" . "\t" . "ایجاد کننده" . "\t" . "نام" . "\t"."نام خانوادگی" . "\t" ."جنسیت"."\t".
    "تلفن همراه" . "\t" . "کد ملی" . "\t"."کد پرسنلی" . "\t" . "آدرس" . "\t" . "تصویر" . "\t"."منطقه" .
    "\t" . "نوع قرارداد" . "\t" . "تاریخ قرارداد" . "\t" . "عنوان سمت" . "\t"."تاریخ تولد"."\t"."تاریخ ایجاد" . "\t"."وضعیت همکاری"."\t"."توضیحات" . "\t";

header("Content-type: application/octet-stream");
header("Content-Disposition: attachment; filename=contacts-$jalali-$date.xls");
