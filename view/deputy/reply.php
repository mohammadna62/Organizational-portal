    ...
    <div class="div_1_2_last" style="height:fit-content">
        <div class="div_client_padding">
            <fieldset
                ...
                <form  method="post" name="senddeputy" onsubmit="return checkFormValidation('senddeputy', 'text');"
                       enctype="multipart/form-data" action="?c=deputy&a=sendreply" style="padding-right: 8px">
                    <div class="div_370">
...
<script>
    ...
    function checkFormValidation(senddeputy,text) {
