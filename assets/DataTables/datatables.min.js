...
!function (n) {
    ...
    return d.extend(!0, n.defaults, {renderer: "bootstrap"}), d.extend(!0, n.ext.classes, {
        ...
        return {display: o, clicker: d("<a>", {href: a ? null : "#", class: "page-link"}).html(n).appendTo(o)}
        ...
        var o = d("<div/>", {class: n.full ? "row mt-2 justify-content-md-center" : "row mt-2 justify-content-between"}).appendTo(t);
        d.each(n, function (e, t) {
            e = t.table ? "col-12" : "start" === e ? "col-md-auto me-auto" : "end" === e ? "col-md-auto ms-auto" : "col-md";
            d("<div/>", {id: t.id || null, class: e + " " + (t.className || "")}).append(t.contents).appendTo(o)
        })
    }, n
});
